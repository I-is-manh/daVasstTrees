...
<body class="bodySignUp">
    ...
    <form action="../../daVasstTree/signup.aspx" method="post" class="formSignUp" runat="server">
        ...
        <%--phần này cho câu clo2--%>
       <%-- <div class="formSignUp__repassword">
            <input type="text" name="maxacnhan" value="" id="maxacnhaninp" class="formSignUp__repassword__inp" />
            <span class="formSignUp__repassword__label" id="maxacnhanlabel">Mã xác nhận</span>
            <label class="formSignUp__maxacnhan__error"></label>
        </div>--%>
