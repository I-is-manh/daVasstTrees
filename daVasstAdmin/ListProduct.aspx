<%@ Page Title="" Language="C#" MasterPageFile="~/daVasstAdmin/daVasstAdmin.Master" AutoEventWireup="true" CodeBehind="ListProduct.aspx.cs" Inherits="daVasstTrees.daVasstAdmin.WebForm1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <link href="../daVasst_Store/LinkCss/listproductAdmin.css" rel="stylesheet" type="text/css" />
        ...
        <div class="listTrees" id="listTrees" runat="server">
            <div class="listTrees-item">
                ...
                <div class="listTrees-item-info">
                    ...
                    <div>
                        <button class="btnAll"><a href="#">Sửa</a></button>
                        <button class="btnAll"><a href="#">Xóa</a></button>
                    </div>
                </div>
            </div>
            <div class="listTrees-item">
            ...
            <div class="listTrees-item">
                ...
                <div class="listTrees-item-info">
                    <p class="listTrees-item-info__name">Sen đá ngọc</p>
                    <p class="listTrees-item-info__price">100.000 đ</p>
                    <button class="listTrees-item-info__btn"><a href="#">Sửa</a></button>
                    <button class="listTrees-item-info__btn"><a href="#">Xóa</a></button>
                </div>
            </div>
            <div class="listTrees-item">
                <div class="listTrees-item__surro">
